            ...
            R.id.btnBuscar -> {
                ...
                if (vericarFormulario("buscar")) {
                    ...
                    if (cursor != null && cursor.count > 0) {
                        ...
                        val catPosition = (cmbCategorias?.adapter as? ArrayAdapter<String>)?.getPosition(managerCategoria?.searchNombre(idCat))

                        if (catPosition != null && catPosition >= 0) cmbCategorias?.setSelection(catPosition)
    ...
    private fun vericarFormulario(opc: String): Boolean {
        ...
        if (opc == "insertar" || opc == "actualizar") {
            ...
            if (opc == "actualizar") {
                ...
                response = !(nombre_v == false || precio_v == false || cantidad_v == false || idproducto_v == false)

            } else response = !(nombre_v == false || precio_v == false || cantidad_v == false)
