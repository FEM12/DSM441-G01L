...
class MainActivity2 : AppCompatActivity() {
    ...
    // Metodo que se llama cuando la actividad se crea por primera vez
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.calculadora) // Establece el archivo de diseño para esta actividad
        ...
        // Configuración de los listeners para los botones, que llaman al metodo calculate con la operacion correspondiente
    ...
    // Metodo que realiza el calculo segun la operacion proporcionada
