...
class LifeCycleObserver (
    ...
    /**
     * Se llama cuando la actividad entra en estado Started (visible para
    el usuario).
     */
    ...
    /**
     * Se llama cuando la actividad entra en estado Paused (parcialmente
    visible, por ejemplo, al abrir otra app encima).
     */
